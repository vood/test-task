...
export function buildCodexPrompt(question: string, mode: QueryMode = "json", conversation: ConversationTurn[] = []) {
  ...
  return [
    ...
    "Use .internal/source-metadata.json documentDate/dateSource fields for recency and provenance. Treat filesystem timestamps as technical fallback metadata, not document dates.",
    ...
    "Freshness: mention document dates and source metadata only when relevant to trust or ordering.",
